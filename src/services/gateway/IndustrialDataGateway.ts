...
export class OpcUaGatewayAdapter implements IIndustrialChannelAdapter {
  ...
  async readTag(tagAddress: string): Promise<IndustrialDataPoint | null> {
    ...
    return {
      ...
      driverId: "opc-gateway-01",
      protocol: "OPC_UA",
      deviceId: "PLC-TANDEM-01",
      assetId: "PLC-TANDEM-01",
      tagId: tagAddress,
      value: 452.4,
      engineeringUnit: "TCH",
      dataType: "FLOAT32",
...
export class MqttSparkplugGatewayAdapter implements IIndustrialChannelAdapter {
  ...
  async readTag(tagAddress: string): Promise<IndustrialDataPoint | null> {
    ...
    return {
      runtimeMode: "LAB",
      sourceType: "PLC",
      sourceId: "EDGE-UNS-01",
      driverId: "spb-gateway-01",
      protocol: "SPARKPLUG_B",
      deviceId: "EDGE-UNS-01",
      assetId: "EDGE-UNS-01",
      tagId: tagAddress,
      value: 64.8,
      engineeringUnit: "bar",
...
export class RestApiGatewayAdapter implements IIndustrialChannelAdapter {
  ...
  async readTag(tagAddress: string): Promise<IndustrialDataPoint | null> {
    ...
    return {
      runtimeMode: "LAB",
      sourceType: "LAB_INSTRUMENT",
      sourceId: "LAB-CORE-SAMPLER",
      driverId: "lims-rest-01",
      protocol: "REST_API",
      deviceId: "LAB-CORE-SAMPLER",
      assetId: "LAB-CORE-SAMPLER",
      tagId: tagAddress,
      value: 15.4,
      engineeringUnit: "% Pol",
      dataType: "FLOAT32",
...
export class HistoricalCsvGatewayAdapter implements IIndustrialChannelAdapter {
  ...
  async readTag(tagAddress: string): Promise<IndustrialDataPoint | null> {
    ...
    return {
      ...
      driverId: "csv-replay-01",
      protocol: "REST_API",
      deviceId: "HISTORICAL-ARCHIVE",
      assetId: "HISTORICAL-ARCHIVE",
      tagId: tagAddress,
      value: 440.0,
      engineeringUnit: "TCH",
      dataType: "FLOAT32",
...
export class IndustrialSimulatorGatewayAdapter implements IIndustrialChannelAdapter {
  ...
  async readTag(tagAddress: string): Promise<IndustrialDataPoint | null> {
    ...
    return {
      runtimeMode: "SIMULATION",
      sourceType: "SIMULATOR",
      sourceId: "SIMULATED-CORE",
      driverId: "sim-twin-01",
      protocol: "SIMULATOR",
      deviceId: "SIMULATED-CORE",
      assetId: "SIMULATED-CORE",
      tagId: tagAddress,
      value: 450.0,
      engineeringUnit: "TCH",
      dataType: "FLOAT32",
